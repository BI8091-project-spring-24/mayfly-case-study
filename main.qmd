...
::: {#fig-predictions layout-nrow=2}
![Spatial predictions based on the presence-only model for the entire dataset.](plot_presence_only.png){#fig-po_pred} 

![Spatial predictions based only on the presence-absence from the NTNU University museum.](plot_pa_only_mod.png){#fig-pa_pred} 

![Spatial predictions based on the intergrated species distribution model.](plot_integrated_model.png){#fig-integrated_pred}
