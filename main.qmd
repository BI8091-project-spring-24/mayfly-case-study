...
From inspecting the cleaned dataset, we see that both the Environmental Agency and NINA are missing information on sampling protocol. By comparison, the NTNU University Museum provides a sampling protocol for nearly all samples (14173 out of 14184 occurrences).

On the basis of this,

They will, together with the smaller datasets, be treated as presence-only data.
