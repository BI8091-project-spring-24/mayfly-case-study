...
Key parameters of the fitted models are shown in table(REF)

Prediction maps of the intensity of *B. rhodani* occurence were created for Norway based on each of the four models, as seen in @fig-predictions.
...
All in all, we argue that this report presents a simple and reproducible workflow demonstrating the potential of using "raw" GBIF data in combination with high-quality, structured datasets (either from GBIF or outside) in an integrated SDM framework.
