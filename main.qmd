...
See file "data_mapping.R". Plotting a figure of the results below. When aggregating insectdata to spatial datapoints (based on lat,long), we get 5964 points in total. Keeping only datapoints within 3700 meters from a river leaves x datapoints.
